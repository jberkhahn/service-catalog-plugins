...
import (
	...
	"github.com/jberkhahn/service-catalog-plugins/pkg/svccat_client"
	"github.com/jberkhahn/service-catalog-plugins/pkg/svccat_client/fakes"
...
var _ = Describe("Instances", func() {
	var (
		client                *svccat_client.SvcCatClient
		err                   error
	...
	BeforeEach(func() {
		client, err = svccat_client.NewClient()
