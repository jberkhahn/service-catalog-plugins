...
func (c *SvcCatClient) GetInstance(instanceName, namespace string) (*v1beta1.ServiceInstance, error) {
	instance, err := c.ScClient.ServicecatalogV1beta1().ServiceInstances(namespace).Get(instanceName, v1.GetOptions{})
	return instance, err
}

func (c *SvcCatClient) ListInstances(namespace string) (*v1beta1.ServiceInstanceList, error) {
