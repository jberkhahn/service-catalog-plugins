...
func (c *SvcCatClient) GetBinding(bindingName, namespace string) (*v1beta1.ServiceBinding, error) {
	binding, err := c.ScClient.ServicecatalogV1beta1().ServiceBindings(namespace).Get(bindingName, v1.GetOptions{})
	return binding, err
}

func (c *SvcCatClient) ListBindings(namespace string) (*v1beta1.ServiceBindingList, error) {
