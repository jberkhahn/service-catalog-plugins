...
func (c *SvcCatClient) GetBroker(brokerName string) (*v1beta1.ClusterServiceBroker, error) {
	broker, err := c.ScClient.ServicecatalogV1beta1().ClusterServiceBrokers().Get(brokerName, v1.GetOptions{})
	return broker, err
}

func (c *SvcCatClient) ListBrokers() (*v1beta1.ClusterServiceBrokerList, error) {
